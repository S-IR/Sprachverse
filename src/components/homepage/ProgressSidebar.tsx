...
const ProgressSidebar = ({ progressStage }: props) => {
  return (
...
const ProgressRow = ({
  ...
  return (
    <div className="mt-14 flex w-full items-center justify-center space-x-4 p-4 align-middle">
      <p
        className={`flex h-20  w-20 items-center justify-center rounded-full border-2 ${borderColor} ${textColor} text-center align-middle font-cinzel  text-4xl font-bold `}
      >
        {rowObj.number}
      </p>
      <p
